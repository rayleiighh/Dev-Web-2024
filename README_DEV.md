...
Changer la structure du fichier dans **backend/routes/mesures.js** : 
```
...
Changer dans server.js dans backend : 
```
...
Changer dans le api.js du frontend dans le dossier services qui est dans le dossier sources : 
```
